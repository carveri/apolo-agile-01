...
const linksTecnico = [
  {
      id:1,
      href: '/dashboard/cliente/visionario',
      nombre: 'Home',
      icono: homeClientes
  },
  {
      id:2,
      href: '/dashboard/cliente/visionario/clienteAgregarTarea',
      nombre: 'Agregar Historia',
      icono: agregarTareasClientes
  },
  {
      id:3,
      href: '/dashboard/cliente/visionario/clienteHistoriasEnviadas',
      nombre: 'Historias Enviadas',
      icono: historiasEnviadasClientes
  },
  {
      id:4,
      href: '/dashboard/cliente/visionario/clienteResolucionTarea',
      nombre: 'Historias Retornadas',
      icono: resolucionTareasClientes
  },
  {
      id:5,
      href: '/dashboard/cliente/visionario/clienteHistoriasAceptadas',

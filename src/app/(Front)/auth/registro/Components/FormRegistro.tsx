    ...
    <form onSubmit={handleSubmitRegistro} className='bg-colorFormularioLogin w-[73%] h-full py-4 px-10 border border-1-gray rounded-md'>
              ...
              <main className='h-[82%] grid grid-rows-9'>
                <div className='grid'>
                  ...
                  <input onChange={handleChangeRegistro} name='primerNombre' className=' rounded h-10 pl-3 bg-gray-100 border border-gray-300' type="text" placeholder='Jorge'/>
                </div>
                <div className='grid'>
                  <label className='h-1 text-white pb-5' htmlFor="">Segundo Nombre</label>
                  <input onChange={handleChangeRegistro} name='segundoNombre' className=' rounded h-10 pl-3 bg-gray-100 border border-gray-300' type="text" placeholder='Luis'/>
                </div>
                <div className='grid'>
                  <label className='h-1 text-white pb-5' htmlFor="">Apellido Paterno</label>
                  <input onChange={handleChangeRegistro} name='apellidoPaterno' className=' rounded h-10 pl-3 bg-gray-100 border border-gray-300' type="text" placeholder='Diaz'/>
                </div>
                <div className='grid'>
                  <label className='h-1 text-white pb-5' htmlFor="">Apellido Materno</label>
                  <input onChange={handleChangeRegistro} name='apellidoMaterno' className=' rounded h-10 pl-3 bg-gray-100 border border-gray-300' type="text" placeholder='Lopez'/>
                </div>
                <div className='grid'>
                ...
                <div className='grid'>
                  ...
                  <input onChange={handleChangeRegistro} name='confirmPassword' className='rounded h-10 pl-3 bg-gray-100' type="password" placeholder='*************'/>
                </div>
              </main>

...
const NavbarHome = () => {
  return (
    <div className='flex h-full w-full  px-2 border-b bg-colorNavbar group '>
        ...
        <ul className='w-[27%] grid grid-cols-4 place-content-center font-medium px-4 group-has-[&>li]:text-colorTexto group-has-[&>li]:justify-items-center'>
            <li>
